...
#### Fact table
1. Row count：因為 fact table 會有<span style="color:rgb(255, 0, 0)">季節性因素</span>所以不要做 day-over-day 的檢查，可能<span style="color:rgb(255, 0, 0)">要做跨週、跨季甚至跨年的比較</span> -> [[Anomaly Detection|anomaly detection#]]
