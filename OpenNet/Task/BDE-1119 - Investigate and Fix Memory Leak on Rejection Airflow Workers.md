...
Happy path 下，CPython reference counting 會在 function 結束時立刻釋放 connection，有無 `conn.close()` 無可量測差異。但 exception 發生時，traceback 持有 local variable reference，connection 無法被 GC，會造成真正的 connection leak
