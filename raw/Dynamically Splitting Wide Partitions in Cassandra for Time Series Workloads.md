...
source: https://netflixtechblog.medium.com/dynamically-splitting-wide-partitions-in-cassandra-for-time-series-workloads-0eded064f456
author:
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*0l0prhKlcOjf-d3-JVQTJg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*sAc4HAMIvLcKTlt9NqOmjQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*uvqa9oj0P6uT-G27WPRJoA.png)

High Tail Latency for Reads (seconds)

This can result in timeouts:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*gcmGxn6NdjRuy0HYQIDv9g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*lj0yVnacUHcE1RQ7iHRKVA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ySI9hOE4_lSScqQ16KQAuw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*016OPfeTjQnGXnUSGdTIKA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*F2gUdVv8NGAqoYbmFVMbnQ.png)
...
Below is an example of over‑partitioning, where the TimeSeries provisioning pipeline selected very small *time\_bucket* intervals based on user provided inputs:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*yCT6SVX5682twAp2VhLPJg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*XM-yySVKVu1YTyt9uPOk-w.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ZMZ1RYb52fha32uStM7w9A.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*HUAyyJeONB-5HVnMihAx8g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*tE44f8HSDXCwvlffOq0w4A.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*t7cz4h3Ebxg-HDyaMVIp_g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*tucaTmgbj6BqhA8YKmUn9A.png)
...
The *wide\_row* metadata table serves as the backbone for state transitions and checkpointing of partition splits. It also stores information that is used later by TimeSeries servers to properly route Read queries.

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*MNIBbz9hTPz-7ah8FRqTZQ.png)

wide\_row metadata for storing split states and checkpoints
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Acbtr-hKcuopZ_7tXpWoxQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*BbADzQfFTZPWUbpORlXfGQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*tif_TQsk2OkBV9CCWrfDJQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*aW9eB9OTQx10HqTASEmWjQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*73ahHVoNRUYaczuEn9KTBA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*t1ZASboghIXdGDyHrz0Z0Q.png)

Latency for checking Bloom filters is extremely small for callers to notice the diversion

For the cases that do end up with a Bloom filter hit, the TimeSeries servers lookup the *wide\_row* metadata to see how to read a specific wide partition:
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*CprO4zk8UQFYulId8jHdUg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*AspDR7sF38JxFXTkaK1wWQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*la6WvWA4KWUglIPWpG27qw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*sELeFr6fngTGib_gcD2ejA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*AZuNdkiqBRtlcLhJBC-MzA.png)

Existing average latency for reading wide partitions

to *low double-digit milliseconds!*

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*y8H7tjqj-g2-ZRGPBkUl_A.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*JbNIJYjARHjGJH77-FiV7w.png)

Existing tail latency for reading wide partitions

to around 200 ms or better:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*qKneKuGrpiU0VoMRw7OOZQ.png)

Tail latency for reading dynamically split partitions

resulting in a drop in read timeouts:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*UjFSHe5HeZeDBKbmayLdnw.png)
